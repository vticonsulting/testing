...
- [2. Tips and Tricks](#2-tips-and-tricks)
  - [2.1. Alfred Workflows](#21-alfred-workflows)
  - [2.2. Developer Scripts](#22-developer-scripts)
  - [2.3. Standards](#23-standards)
  - [2.4. icons](#24-icons)
    - [2.4.1. No scoped styles](#241-no-scoped-styles)
  - [2.5. Data Dictionary](#25-data-dictionary)
  - [Title: Text dump of Data Dictionary](#title-text-dump-of-data-dictionary)
  - [2.6. Table Of Contents](#26-table-of-contents)
  - [2.7. FAQ/Help Desk Pages - Not Logged In](#27-faqhelp-desk-pages---not-logged-in)
    - [2.7.1. Business Logic/Functionality](#271-business-logicfunctionality)
    - [2.7.2. FAQ (not logged in)](#272-faq-not-logged-in)
  - [2.8. FAQ/Help Desk Pages - Logged In](#28-faqhelp-desk-pages---logged-in)
    - [2.8.1. Business Logic/Functionality](#281-business-logicfunctionality)
    - [2.8.2. FAQ (logged in)](#282-faq-logged-in)
  - [2.9. Auth Login Page](#29-auth-login-page)
  - [2.10. Sign up page](#210-sign-up-page)
  - [2.11. Forgot Password Page](#211-forgot-password-page)
  - [2.12. Get Pledges](#212-get-pledges)
  - [2.13. Get Pledges - Easy Emailer](#213-get-pledges---easy-emailer)
  - [2.14. Get Pledges - Share](#214-get-pledges---share)
  - [2.15. Home Dashboard](#215-home-dashboard)
- [3. #Pledge Process (Step 3)](#3-pledge-process-step-3)
  - [3.1. Pay Online Pledges Now](#31-pay-online-pledges-now)
  - [3.2. Pay Online Pledges Now - Payment Details](#32-pay-online-pledges-now---payment-details)
  - [3.3. Public Dashboard](#33-public-dashboard)
  - [3.4. Registration Page](#34-registration-page)
  - [3.5. Registration Page - Register Participant](#35-registration-page---register-participant)
  - [3.6. Rewards Page](#36-rewards-page)
  - [3.7. Locker Ads](#37-locker-ads)
  - [3.8. My Pledges](#38-my-pledges)
  - [3.9. My Pledges - My Sponsors](#39-my-pledges---my-sponsors)
  - [3.10. Student Dashboard](#310-student-dashboard)
  - [3.11. Stats Page](#311-stats-page)
  - [3.12. State Map](#312-state-map)
  - [3.13. Edit Account Profile Page](#313-edit-account-profile-page)
  - [3.14. Update Student Profile Page](#314-update-student-profile-page)
  - [3.15. Update Student Profile Page - About You](#315-update-student-profile-page---about-you)
  - [3.16. Update Student Profile Page - Personalize](#316-update-student-profile-page---personalize)
  - [3.17. Update Student Profile Page - View Participant Agreement](#317-update-student-profile-page---view-participant-agreement)
  - [3.18. Locker Prizes](#318-locker-prizes)
  - [3.19. Locker Prize List - Create/Edit Prize](#319-locker-prize-list---createedit-prize)
  - [3.20. Task Lists Page](#320-task-lists-page)
  - [3.21. Task Lists Page - Edit Task List](#321-task-lists-page---edit-task-list)
  - [3.22. Participants Page](#322-participants-page)
  - [3.23. Teachers Page](#323-teachers-page)
  - [3.24. Sponsors Page](#324-sponsors-page)
  - [3.25. Classes Page](#325-classes-page)
  - [3.26. Classes Page - Add a Class](#326-classes-page---add-a-class)
  - [3.27. Classes Page - Upload Class List](#327-classes-page---upload-class-list)
  - [3.28. Classes Page - Add All Missing {Unit Types}](#328-classes-page---add-all-missing-unit-types)
  - [3.29. Classes Page - View Class](#329-classes-page---view-class)
  - [3.30. Classes Page - Edit Class](#330-classes-page---edit-class)
  - [3.31. Classes Page - Add Participant](#331-classes-page---add-participant)
  - [3.32. Classes Page - Add {Unit Types}](#332-classes-page---add-unit-types)
  - [3.33. Users Tab](#333-users-tab)
  - [3.34. User Groups Tab](#334-user-groups-tab)
  - [3.35. User Groups Tab - Edit User Group](#335-user-groups-tab---edit-user-group)
  - [3.36. Schools Tab](#336-schools-tab)
- [4. #Schools Tab - Programs](#4-schools-tab---programs)
  - [4.1. Schools Tab - Merchant Account](#41-schools-tab---merchant-account)
  - [4.2. Schools Tab - Locker Administrators](#42-schools-tab---locker-administrators)
  - [4.3. Schools Tab - School Info](#43-schools-tab---school-info)
  - [4.4. Convenience Fees](#44-convenience-fees)
  - [4.5. Global Components (Hyperlinks)](#45-global-components-hyperlinks)
  - [4.6. Additional Components (Tooltips)](#46-additional-components-tooltips)
...
## 2.7. FAQ/Help Desk Pages - Not Logged In
...
### 2.7.1. Business Logic/Functionality
...
## 2.8. FAQ/Help Desk Pages - Logged In

The FAQ Pages are questions and answers that parents and/or sponsors may potentially have and can access on their own without reaching out to customer support. The Help Desk is a way for parents and/or sponsors to reach out to customer support for specific questions, which will be replied back via Zendesk.

### 2.8.1. Business Logic/Functionality
...
## 3.2. Pay Online Pledges Now - Payment Details
...
## 3.5. Registration Page - Register Participant
...
## 3.13. Edit Account Profile Page
...
## 3.16. Update Student Profile Page - Personalize
...
## 3.17. Update Student Profile Page - View Participant Agreement
...
## 3.19. Locker Prize List - Create/Edit Prize
...
## 3.21. Task Lists Page - Edit Task List
...
## 3.27. Classes Page - Upload Class List
...
## 3.28. Classes Page - Add All Missing {Unit Types}
...
## 3.31. Classes Page - Add Participant
...
## 3.32. Classes Page - Add {Unit Types}
...
## 3.35. User Groups Tab - Edit User Group
...
## 4.1. Schools Tab - Merchant Account
...
## 4.2. Schools Tab - Locker Administrators
...
## 4.5. Global Components (Hyperlinks)
...
## 4.6. Additional Components (Tooltips)
