...
<Meta title="Notes/Animation/GSAP" />

# Using Greensock (gsap)

Workflow + Cross-browser consistency

[gsap]: https://greensock.com/why-gsap/

THE ISSUE WITH LONGER CSS ANIMATIONS:

keyframes1.jpg

##### [More information in this CSS-Tricks article](https://css-tricks.com/debugging-css-keyframe-animations/)
...
// TweenMax .to/.from/.fromTo/.staggerTo ( querySelector, seconds {
//   property: amount,
//   ease
// }, staggerAmt, postitionParam);
TweenMax.to ( '.div', 1 {
  x: 100,
  ease: Sine.easeOut
});
