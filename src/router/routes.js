...
export default [
  ...
  },
  {
    path: '/nested-route',
    name: 'nested-route',
    component: () => import(/* webpackChunkName: "nested-route" */ '@/router/views/NestedRoute.vue'),
  },
  {
    path: '/login',
    name: 'login',
  ...
  },
  {
    path: '/404',
    name: '404',
    component: require('@/router/views/_404.vue').default,
...
function lazyLoadView (AsyncView) {
  const AsyncHandler = () => ({
    ...
    loading: require('@/router/views/_Loading.vue').default,
    // Delay before showing the loading component.
    // Default: 200 (milliseconds).
    delay: 400,
    // A fallback component in case the timeout is exceeded
    // when loading the component.
    error: require('@/router/views/_Timeout.vue').default,
